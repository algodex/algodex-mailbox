...
const RedeemAssets = {
  getEscrowBalance: async function (assetId, receiverAddress, senderAddress, formatBalance = true) {
    ...
    return await helper.getFormattedAssetBalance(encodedAddress, assetId, formatBalance)
  },
