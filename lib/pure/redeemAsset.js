// const getEscrowBalance = require('@/lib/pure/getEscrowBalance')
 ...
 * @returns {Promise}
 */
async function redeemAsset({client, asset, wallets:{to: receiverWallet, from:senderWallet}}) {
  ...
  //return {client, asset, wallets:{to: receiverWallet, from:senderWallet}}
}
